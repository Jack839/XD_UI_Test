  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-25.0, -12.0, 439.9, 445.2),
            size: Size(398.0, 813.0),
            pinLeft: true,
            pinRight: true,
            pinTop: true,
            child:
            // Adobe XD layer: '78957-OFNJZ3-20_fli…' (shape)
            Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/tracking_bg.png'),
                  fit: BoxFit.fill,
          ...
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(18.0, 19.0, 38.0, 38.0),
                  size: Size(146.5, 149.6),
                  pinTop: true,
                  child:
                  ...
                  Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image:
                        const AssetImage('assets/images/delete_icon.png'),
                        fit: BoxFit.fill,
                        colorFilter: new ColorFilter.mode(
                            Colors.black.withOpacity(0.5), BlendMode.dstIn),
                      ),
          ...
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(18.0, 17.0, 40.0, 40.0),
                  size: Size(146.5, 149.6),
                  pinTop: true,
                  child:
          ...
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(20.0, 19.0, 38.0, 38.0),
                  size: Size(146.5, 149.6),
                  pinTop: true,
                  child:
          ...
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(22.0, 21.0, 35.0, 35.0),
                  size: Size(146.5, 149.6),
                  pinTop: true,
                  child:
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(349.7, 56.0, 36.0, 36.0),
            size: Size(398.0, 813.0),
            pinRight: true,
            pinTop: true,
            fixedWidth: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(357.7, 64.0, 20.0, 20.0),
            size: Size(398.0, 813.0),
            pinRight: true,
            pinTop: true,
            fixedWidth: true,
